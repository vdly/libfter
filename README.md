...
**make flcean**	- clear all (\*.o) files and library
...
ft_isprint	- a fucntion that checks if c is a printable character
...
ft_strlen	- a function that calculates the lenght of s
